...
export class AiService {
  ...
  async planExecutorActions(input: {
    ...
    const prompt = [
      ...
      "Do not invent missing required reminder details. If the user's time is still vague, such as afternoon, evening, later, sometime tomorrow, or after work, do not create or update a reminder yet.",
