...
const dictionaries: Record<Locale, Dictionary> = {
  zh: {
    ...
    strings: {
      ...
      command_dream: "强制立即入梦",
      trusted_only_command: "这个命令仅限可信用户使用。",
      dream_started: "已开始强制入梦。",
      dream_failed: "强制入梦失败：{error}",
      ...
      reminder_notification_now: "准时",
      reminder_detail_recipients: "对象：{value}",
      reminder_detail_time: "时间：{value}",
      reminder_detail_time_semantics: "时间语义：{value}",
      reminder_detail_timezone: "时区：{value}",
      reminder_detail_notifications: "提醒：",
      reminder_detail_none: "- 无",
      reminder_time_semantics_absolute: "固定时间",
      reminder_time_semantics_local: "本地时间",
      reminder_recipients_unspecified: "未指定",
  ...
  en: {
    ...
    strings: {
      ...
      command_dream: "Force a dream cycle now",
      trusted_only_command: "This command is only available to trusted users.",
      dream_started: "Started a forced dream cycle.",
      dream_failed: "Forced dream cycle failed: {error}",
      ...
      reminder_notification_now: "On time",
      reminder_detail_recipients: "Recipients: {value}",
      reminder_detail_time: "Time: {value}",
      reminder_detail_time_semantics: "Time semantics: {value}",
      reminder_detail_timezone: "Time zone: {value}",
      reminder_detail_notifications: "Notifications:",
      reminder_detail_none: "- None",
      reminder_time_semantics_absolute: "Absolute time",
      reminder_time_semantics_local: "Local time",
      reminder_recipients_unspecified: "Unspecified",
